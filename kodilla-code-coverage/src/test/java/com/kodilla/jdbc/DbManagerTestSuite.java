...
public class DbManagerTestSuite {
    ...
    @Test
    public void testSelectUsersAndPosts2() throws SQLException {
        ...
        String sql = "INSERT INTO POSTS(USER_ID, BODY) VALUES (3, 'Hello')";
        statement.executeUpdate(sql);
        sql = "INSERT INTO POSTS(USER_ID, BODY) VALUES (3, 'Welcome all')";
        statement.executeUpdate(sql);
        sql = "INSERT INTO POSTS(USER_ID, BODY) VALUES (3, 'All the best')";
        statement.executeUpdate(sql);
